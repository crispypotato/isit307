...
if ($errors == 0) {
    ...
    try {
        $sql = "INSERT INTO $table " . " (name, surname, email, phone, type) " . " VALUES( '$nm', '$surname', '$email', '$phone', 'admin'".")";
...
if ($errors == 0) {
	$body .= "<form method='post' " . 	" action='parkingAdmin.php?PHPSESSID=" . session_id() . "'>\n";
